<template>
  <div class="sidenav-container">
    ...
    ></div>
    <transition name="slide-side" @enter="enter" @leave="leave">
      <div v-if="isSidebar" class="sidenav row">
        <section class="sidenav__interaction col-md-5">
          ...
          >
            <g data-name="Design 1" transform="translate(-605 -127.3)">
              <path
                data-name="Path 15"
        ...
        <section class="sidenav__content col-md-7">
              ...
              <ul class="mainNav__list">
                <li class="mainNav__item" @click="hideSidebar">
                  ...
                  <nuxt-link
                    ...
                    :to="'/' + $i18n.locale"
                  >
                    <AnimationText :text="$t('links.home')" />
                  </nuxt-link>
                </li>
                <li class="mainNav__item" @click="hideSidebar">
                  ...
                  <nuxt-link
                    ...
                    :to="'/' + $i18n.locale + '/shop'"
                  >
                    <AnimationText :text="$t('links.shop')" />
                  </nuxt-link>
                </li>
                <li class="mainNav__item" @click="hideSidebar">
                  ...
                  <nuxt-link
                    ...
                    :to="'/' + $i18n.locale + '/blog'"
                  >
                    <AnimationText :text="$t('links.blog')" />
                  </nuxt-link>
                </li>
                <li class="mainNav__item" @click="hideSidebar">
                  ...
                  >
                    <AnimationText :text="$t('links.about')" />
                  </nuxt-link>
                </li>
                <li class="mainNav__item" @click="hideSidebar">
                  ...
                  >
                    <AnimationText :text="$t('links.contact')" />
                  </nuxt-link>
                </li>
              </ul>
            </nav>
          ...
          <div class="sidenav__social">
            <SocialMedia :direction="direction" :iconColor="iconColor" />
            <InputSwitch />
          </div>
        </section>
      </div>
...
import { magnetize } from "~/helpers/magnetize";
...
export default {
  ...
  components: { Nav, SocialMedia, InputSwitch, AnimationText },
  data() {
    return {
